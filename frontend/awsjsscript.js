function getPhoto()
{
  var apigClient = apigClientFactory.newClient({
                     apiKey: "x7etNOA6EBdPnfR2OP2C2rWUWV188KY9fPQWVv10"
        });
    ...
    apigClient.searchGet(params, body , additionalParams).then(function(result){
        ...
        rdata.forEach( function(obj) {
            var img = new Image();
            img.src = "https://photostoreobj.s3.amazonaws.com/"+obj;
...
function submitPhoto()
{
   ...
   var base64_image = convertImgBase64(img_file).then(
     ...
     var params = {"key" : img_file.name, "bucket" : "photostoreobj", "Content-Type" : img_file.type + ";base64", "x-amz-meta-CustomLabels": mlabels};
